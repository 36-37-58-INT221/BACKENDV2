...
public class testRestController {
	...
	{
		test.put("1001", new Product("1001", "ipone", 1200, "good", myObj, "path1", "brandfk1", "haveId1"));
		test.put("1002", new Product("1002", "sumsung", 2555, "bad", myObj, "path2", "brandfk2", "haveId2"));
		test.put("1003", new Product("1003", "nani", 3441, "soso", myObj, "path3", "brandfk3", "haveId3"));
		test.put("1004", new Product("1004", "wtf", 4888, "bruhh", myObj, "path4", "brandfk4", "haveId4"));
		test.put("1005", new Product("1005", "idk", 5200, "GG", myObj, "path5", "brandfk5", "haveId5"));
